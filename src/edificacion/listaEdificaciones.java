...
public class listaEdificaciones {
    ...
    public void mostrar(){
        ...
        for(Edificacion e: listaEdificaciones){
            System.out.println(i+" "+e.nombre+" vida: "+e.vida+". Costo: Oro="+e.costo_oro+" Piedra= "+e.costo_piedra+" Comida= "+e.costo_comida+" Tiempo de espera="+e.cooldown+" "+e.descripcion_extra);
            i++;
        }
    }
}
